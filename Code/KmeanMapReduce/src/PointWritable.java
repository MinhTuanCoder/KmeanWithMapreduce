...
public class PointWritable implements Writable {
	...
	public PointWritable() {
		this.dim = 0; //set kích thước của point là 0
	}
	...
	public void sum(PointWritable p) { //Hàm tính tổng các điểm
		for (int i = 0; i < this.dim; i++) {
	...
	public double calcDistance(PointWritable p) { //hàm tính khoảng cách giữa 2 điểm
	...
	public void calcAverage() {//Tính trung bình cộng giữa các điểm
		for (int i = 0; i < this.dim; i++) {
